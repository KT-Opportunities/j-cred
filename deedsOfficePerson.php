...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | Deeds Office Person</title>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['DeedsOfficePersonSubmit'])){
                $ref = $_POST['ref'];
                ...
                $_SESSION['Sequestration'] = "false";
                
                $d8 = date('Y-m-d');
                $time = date('h:i:s');
                $cu_email = $_SESSION["email"];
                $action = "Database Office Person: DeedsOffice=$DeedsOffice;Surname=$Surname;Firstname=$Firstname;IDNumber=$IDNumber";
                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Database Office Person','$action','$cu_id','$cu_email')";
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">Database Office Person</h3>
                       <ul><li>
                        <input type="text" name="ref" class="field-style field-split align-left" placeholder="Reference" />
                        
                        <select class="field-style field-split align-right" id="DeedsOffice"  name="DeedsOffice">
                        ...
                        <input type="text" class="field-style field-split align-left" id="Firstname" placeholder="Firstname"   name="Firstname">
                        
                        <input type="text" class="field-style field-split align-right" id="Surname" placeholder="Surname"   name="Surname">
                        </li><li>
                        <input type="text" class="field-style field-split align-left" id="IDNumber" placeholder="ID Number"  name="IDNumber">
                        </li><li>
                        <button type="submit" class="reset"  name="DeedsOfficePersonSubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/DeedsOfficePerson_IndiviualSearch.php",
            // data: data4,
            ...
            console.log('Done1')
                ...
                // var compu = '';
                var dem = '';
                dem += '<h5><b>' +result.ResponseMessage+ '</b></h5>';
                 $('#dem').append(dem);
