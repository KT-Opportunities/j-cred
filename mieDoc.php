        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">MIE Documents</h3>
                        <ul><li>
                        ...
                        </li><li><input type="text" class="field-style field-split align-left" id="licenseNumber"  name="licenseNumber" placeholder="License Number">
                        </li><li>
                        <button type="submit" class="reset" id="btnS" name="mieSubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
//  var data2 
        $.ajax({
        type:"GET",
        url:"php/MIEVehicleOwnershipCheck.php",
        // data: data2,
        dataType: "json",
        success:function(result){
