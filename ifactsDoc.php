...
<html>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['iFactsSubmit'])){
                $ref = $_POST['ref'];
                
                $Surname = $_POST['Surname'];
                $Firstname = $_POST['Firstname'];
                $IDNumber = $_POST['IDNumber'];
                $PrescribedPurpose = $_POST['PrescribedPurpose'];


                $_SESSION['PrescribedPurpose'] = $PrescribedPurpose;
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">iFacts Documents</h3>
                        <ul><li>
                        ...
                        </li><li><input type="text" class="field-style field-split align-left" id="Firstname"  name="Firstname" placeholder="First Name">
                        <input type="text" class="field-style field-split align-right" id="IDNumber"  name="IDNumber" placeholder="ID Number">
                        </li><li><input type="text" class="field-style field-split align-left" id="PrescribedPurpose"  name="PrescribedPurpose" placeholder="Prescribed Purpose">
                        </li><li>
                        <button type="submit" class="reset" id="btnS" name="iFactsSubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
//  var data2 
        $.ajax({
        type:"GET",
        url:"php/iFactsDriversLicenseCheck.php",
        // data: data2,
        dataType: "json",
        success:function(result){
