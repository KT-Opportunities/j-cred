...
<html>
    ...
    <body>
        <?php 
        // session_destroy();
        if(isset($_POST['ComCredSubmit'])){
            $ContactName = $_POST['comCon'];
            $ContactNumber = $_POST['comNum'];
            ...
            $_SESSION['EnquiryReason'] = $EnquiryReason;
            ...
            $action ="New Search: ContactName=$ContactName;ContactNumber=$ContactNumber;EnquiryReason=$EnquiryReason;IDNumber=$IDNumber;FirstName=$FirstName;Surname=$Surname";

            $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','combinedCreditReport.php','$action','$cu_id','$cu_email')";
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">Combined Credit Report</h3>
                        ...
                        <ul>
                            <li>
                                ...
                                <select class="sea-input field-style field-split align-left" id="DeedsOffice" style="height: 36px;" name="EnquiryReason">
                                    ...
                                    <option value="32">Credit Application</option>
                                    <option value="43">Affordability / Credit Assessment</option>
                                    <option value="33">Credit Limit Management</option>
                                    <option value="36">Employment And / Or Educational Check</option>
                                    <option value="34">Insurance Application</option>
                                    <option value="45">Debt Review Application</option>
                                    <option value="39">Fraud Detection and Fraud Prevention</option>
                            ...
                            <li>
                                <br>
                                <input type="submit" name="ComCredSubmit" value="Search" />
                            </li>
                        </ul>
...
$(document).ready(function(){
    // $(document).on('click', '#btnS', function() {
            ...
            $.ajax({
            type:"GET",
            url:"php/combinedConsumerCreditReport.php",
            // data: data4,
            ...
            success:function(result){
                ...
                // console.log('V: ' ,(JSON.stringify(result.ResponseObject.PersonInformation.IDNumber).substr(1).slice(0, -1)));
                ...
                // document.getElementById("demo7").innerHTML += (JSON.stringify(result.ResponseObject.PersonInformation.Fullname).substr(1).slice(0, -1));
                // document.getElementById("demo8").innerHTML += (JSON.stringify(result.ResponseObject.PersonInformation.Surname).substr(1).slice(0, -1));
                // document.getElementById("demo9").innerHTML += (JSON.stringify(result.ResponseObject.PersonInformation.IDNumber).substr(1).slice(0, -1));
                // document.getElementById("demo10").innerHTML += (JSON.stringify(result.ResponseObject.PersonInformation.Gender).substr(1).slice(0, -1));
                // document.getElementById("demo11").innerHTML += (JSON.stringify(result.ResponseObject.PersonInformation.Age).substr(1).slice(0, -1));
                // document.getElementById("demo12").innerHTML += (JSON.stringify(result.ResponseObject.PersonInformation.DateOfBirth).substr(1).slice(0, -1));
