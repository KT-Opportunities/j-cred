    ...
    <body>
        <?php 
            ...
            if(isset($_POST['xdsSubmit'])){
                ...
                $_SESSION['ClientEmailAddress'] = $ClientEmailAddress;
...
<li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="text" class="field-style field-split align-right" id="CompanyName"  name="CompanyName" placeholder="Company Name"></li><li>
                        ...
                        </li><li><input type="text" class="field-style field-split align-left" id="Surname"  name="Surname" placeholder="Surname">
                        <input type="text" class="field-style field-split align-right" id="Firstname"  name="Firstname" placeholder="First Name">
                        </li><li><input type="text" class="field-style field-split align-left" id="IDNumber"  name="IDNumber" placeholder="ID Number">
                        <input type="text" class="field-style field-split align-right" id="AccountNumber"  name="AccountNumber" placeholder="Account Number">
                       </li><li> <input type="text" class="field-style field-split align-left" id="BranchCode"  name="BranchCode" placeholder="Branch Code">
                        <input type="text" class="field-style field-split align-right" id="AccountType"  name="AccountType" placeholder="Account Type">
                        </li><li><input type="text" class="field-style field-split align-left" id="BankName"  name="BankName" placeholder="Bank Name">
                        ...
                        </li><li><input type="text" class="field-style field-split align-left" id="ClientSurname"  name="ClientSurname" placeholder="Client Surname">
                        ...
                        <button type="submit" class="reset" id="btnS" name="xdsSubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
//  var data2 
        $.ajax({
        type:"GET",
        url:"php/XDSAccountVerificationDocumentRequest.php",
        // data: data2,
        dataType: "json",
        success:function(result){
