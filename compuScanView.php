...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | CompuScan Details View</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="tab">
                  <button class="tablinks active" onclick="openCity(event, 'London')">Address History</button>
                  <button class="tablinks" onclick="openCity(event, 'Paris')">Employment History</button>
                  <button class="tablinks" onclick="openCity(event, 'Tokyo')">Telephone History</button>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/compuScanContactInformation.php",
            // data: data4,
            ...
            console.log('Done1')
                ...
                console.log(('V: ' ,result));
                 ...
                 for (let i = 0; i < result.ResponseObject.HistoricalInformation.AddressHistory.length; i++) {
                    ...
                    Phaddress +='<h5><b>'+result.ResponseObject.HistoricalInformation.AddressHistory[i].TypeCode+'</b></h5>'
                    Phaddress += '<p>' +result.ResponseObject.HistoricalInformation.AddressHistory[i].Line1+ '</p>';
                    Phaddress += '<p>' +result.ResponseObject.HistoricalInformation.AddressHistory[i].Line2+ '</p>';
                    Phaddress += '<p>' +result.ResponseObject.HistoricalInformation.AddressHistory[i].Line3+ '</p>';
                    Phaddress += '<p>' +result.ResponseObject.HistoricalInformation.AddressHistory[i].Line4+ '</p>';
                    Phaddress += '<p>' +result.ResponseObject.HistoricalInformation.AddressHistory[i].PostalCode+ '</p>';
                    Phaddress += '<hr>'
                 }
                    $('#demo').append(Phaddress);
                    
                    var employ = '';
                 for (let i = 0; i < result.ResponseObject.HistoricalInformation.EmploymentHistory.length; i++) {
                     
                    employ +='<p><b>Employer Name:</b> '+result.ResponseObject.HistoricalInformation.EmploymentHistory[i].EmployerName+'</p>'
                    employ += '<p><b>Designation:</b> ' +result.ResponseObject.HistoricalInformation.EmploymentHistory[i].Designation+ '</p>';
                    employ += '<p><b>Last Updated Date:</b> ' +result.ResponseObject.HistoricalInformation.EmploymentHistory[i].LastUpdatedDate+ '</p>';
                 ...
                 for (let i = 0; i < result.ResponseObject.HistoricalInformation.TelephoneHistory.length; i++) {
                    ...
                    tel +='<h5><b>'+result.ResponseObject.HistoricalInformation.TelephoneHistory[i].TypeDescription+'</b></h5>'
                    tel += '<p><b>Number:</b> ' +result.ResponseObject.HistoricalInformation.TelephoneHistory[i].Number+ '</p>';
                    tel += '<p><b>Last Updated Date:</b> ' +result.ResponseObject.HistoricalInformation.TelephoneHistory[i].LastUpdatedDate+ '</p>';
                    ...
                    credit +='<h5><b>FraudIndicatorSummary</b></h5>'
                    credit += '<p>Protective Verification: ' +result.ResponseObject.CreditInformation.FraudIndicatorSummary.ProtectiveVerification+ '</p>';
