...
<html>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['DeedsOfficeDocSubmit'])){
                $ref = $_POST['ref'];
                $DeedsOffice= $_POST['DeedsOffice'];
                $documentNumber = $_POST['documentNumber'];
                $microFilmReferenceNumber = $_POST['microFilmReferenceNumber'];
                

                $_SESSION['DeedsOffice'] = $DeedsOffice;
                $_SESSION['documentNumber'] = $documentNumber;
                $_SESSION['microFilmReferenceNumber'] = $microFilmReferenceNumber;

                $documentNumber = $_SESSION['documentNumber'];
                $microFilmReferenceNumber = $_SESSION['microFilmReferenceNumber'];
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        ...
                        <input type="text" class="field-style field-split align-left" id="documentNumber"  name="documentNumber" placeholder="Document Name">
                        <input type="text" class="field-style field-split align-right" id="microFilmReferenceNumber"  name="microFilmReferenceNumber" placeholder="Micro Film Reference Number">
                        </li><li>
                        
                        <button type="submit" class="reset" id="btnS" name="DeedsOfficeDocSubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
//  var data2 
        $.ajax({
        type:"GET",
        url:"php/DeedsOfficePropertyDocumentRequest.php",
        // data: data2,
        dataType: "json",
        success:function(result){
