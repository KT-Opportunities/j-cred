...
<html>
    ...
    <body>
        <?php 
        // session_destroy();
        if(isset($_POST['CompuScanCISubmitt'])){
            $search = $_POST['IDnum'];
            ...
            $d8 = date('Y-m-d');
                ...
                $action = "CompuScan Contact Information: ID#=$search";

            $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','CompuScan Contact Information','$action','$cu_id','$cu_email')";
...
';
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">CompuScan Contact Information</h3>
