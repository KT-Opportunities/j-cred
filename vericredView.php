...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | VeriCred Details View</title>
...
$(document).ready(function(){
            ...
            console.log('Done1')
                ...
                cred += '<h5>Fraud Indicators Summary</h5>'
                cred += '<p><b>Protective Verification: </b> ' +result.ResponseObject.CreditInformation.FraudIndicatorSummary.ProtectiveVerification+ '</p>';
                ...
                for (let i = 0; i < result.ResponseObject.HistoricalInformation.AddressHistory.length; i++) {
                    ...
                    add += '<td>' +result.ResponseObject.HistoricalInformation.AddressHistory[i].TypeCode+ '</td>';
                ...
                for (let i = 0; i < result.ResponseObject.HistoricalInformation.EmploymentHistory.length; i++) {
                    ...
                    employ += '<td>' +result.ResponseObject.HistoricalInformation.EmploymentHistory[i].LastUpdatedDate+ '</td>';
                ...
                affairs += '<p><b>Cause Of Death:</b> ' +result.ResponseObject.HomeAffairsInformation.CauseOfDeath+ '</p>';
                affairs += '<p><b>Deceased Date: </b> ' +result.ResponseObject.HomeAffairsInformation.DeceasedDate+ '</p>';
                affairs += '<p><b>Deceased Status: </b> ' +result.ResponseObject.HomeAffairsInformation.DeceasedStatus+ '</p>';
                affairs += '<p><b>Verified Date: </b> ' +result.ResponseObject.HomeAffairsInformation.VerifiedDate+ '</p>';
                affairs += '<p><b>Verified Status: </b> ' +result.ResponseObject.HomeAffairsInformation.VerifiedStatus+ '</p>';
