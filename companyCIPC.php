    ...
    <body>
        <?php 
            ...
            if (isset($_POST['searchterm']) && $_POST['searchterm']!=""){
                ...
                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Company CPIC','$action','$cu_id','$cu_email')";
            ...
            if(isset($_POST['ComCIPCSubmit'])){
                $ref = $_POST['ref'];
                $comID= $_POST['comID'];
                $SeaDes = $_POST['SeaDes'];
                $_SESSION['CompanyID'] = $comID;
                $_SESSION['SearchDescription'] = $SeaDes;
                
                $d8 = date('Y-m-d');
                $time = date('h:i:s');
                $cu_email = $_SESSION["email"];
                $action = "New Company CPIC : Ref=$ref;SeaDes=$SeaDes";
                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Company CPIC','$action','$cu_id','$cu_email')";
                    $result1 = mysqli_query($conn,$logs);
                    if($result1){
                    // echo"<script>alert('Organization inserted successfully');</script>";
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        ...
                        <ul><li>
                        <input type="text" class="sea-input" id="ref"  name="ref" placeholder="Reference">
                        <input type="text" class="sea-input" id="comID"  name="comID"  placeholder="Company ID">
                        </li><li><input type="text" class="sea-input" id="SeaDes"  name="SeaDes" placeholder="Search Description"></li><li>
                        
                        <button type="submit" class="reset" id="btnS" name="ComCIPCSubmit">Submit</button></li>
</ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
//  var data2 
        ...
        success:function(result){
         ...
         console.log('CompanyID: ' + result.ResponseMessage);
        }
        });
   });
