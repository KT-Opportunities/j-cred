...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | Database Property Company</title>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['DataProComSubmit'])){
                $ref = $_POST['ref'];
                $DeedsOffice= $_POST['DeedsOffice'];
                $CompanyName = $_POST['CompanyName'];
                $RegistrationNumber = $_POST['RegistrationNumber'];
                
                $_SESSION['DeedsOffice'] = $DeedsOffice;
                ...
                $action = "Database Property Company: ref=$ref;DeedsOffice=$DeedsOffice;CompanyName=$CompanyName;RegistrationNumber=$RegistrationNumber";

                
                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Database Property Company','$action','$cu_id','$cu_email')";
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">Database Property Company</h3>
                        <ul><li>
                        <input type="text" class="field-style field-split align-left" id="ref"  name="ref" placeholder="Reference">
                        <select class="field-style field-split align-right" id="DeedsOffice"  name="DeedsOffice" placeholder="Deeds Office">
                        ...
                        <input type="text" class="field-style field-split align-right" id="RegistrationNumber"  name="RegistrationNumber" placeholder="Registration Number">
                        
                        </li><li>
                        <button type="submit" class="reset" id="btnS" name="DataProComSubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
                    ...
                    <table id="table" class="table table-striped  table-hover" style="margin-top: 24px;">
                            <thead class="head">
                                <tr>
                                    ...
                                    <th scope="col">Deeds Office ID</th>
                                    <th scope="col">Deeds Office Name</th>
                                    <th scope="col">Person Type</th>
                                    <th scope="col">Person Type Code</th>
...
$(document).ready(function(){
            ...
            console.log('Done1')
                ...
                var compu = '';
                    ...
                    compu += '<tr>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.FirstName+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.Surname+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.MiddleName1+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.IDNumber+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.Gender+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.Age+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.DateOfBirth+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.MaritalStatus+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.DeedsOfficeID+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.DeedsOfficeName+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.PersonType+ '</td>';
                    compu += '<td>' +result.ResponseObject.PersonInformation.PersonTypeCode+ '</td>';
                    compu += '<td> <a href="databasePropertyCompanyView.php?x=' +result.ResponseObject.PersonInformation.IDNumber+'&y='  +result.ResponseObject.PersonInformation.Fullname+ '">View<a/></td>';
                    compu += '</tr>';
