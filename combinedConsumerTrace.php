...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | Combined Consumer Trace</title>
    ...
    <body>
        <?php 
        // session_destroy();
        if(isset($_POST['ComConTraceSubmit'])){
            $search = $_POST['IDnum'];
            ...
            $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','combinedConsumerTrace.php','$action','$cu_id','$cu_email')";
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">Combined Consumer Trace</h3>

                        <ul>
                            <li>
                                <input type="text" id="ref"  name="ref" class="field-style field-split align-left" placeholder="Reference" />
                                <input type="text" id="IDnum"  name="IDnum" class="field-style field-split align-right" placeholder="ID Number" />

                            </li>
                           
                            <li>
                                <input type="submit" name="ComConTraceSubmit" value="Search" />
                            </li>
                        </ul>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/CombinedConsumerTrace.php",
            // data: data4,
            ...
            console.log('Done1')
                ...
                //     compu += '<td> <a href="compuScanView.php?x=' +result.ResponseObject.PersonInformation.IDNumber+'&y='  +result.ResponseObject.PersonInformation.Fullname+ '">View<a/></td>';
                //     compu += '</tr>';
