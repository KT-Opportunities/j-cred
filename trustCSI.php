...
<html>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['TrustCSISubmit'])){
                $ref = $_POST['ref'];
                

                $IDNumber = $_POST['IDNumber'];
                $TrustName = $_POST['TrustName'];
                $TrustNumber = $_POST['TrustNumber'];

                $_SESSION['IDNumber'] =  $IDNumber;
                $_SESSION['TrustName'] = $TrustName;
                $_SESSION['TrustNumber'] = $TrustNumber;
...
<li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">CSI Trust Records</h3>
                        <ul><li>
                        <input type="text" class="sea-input" id="ref"  name="ref" placeholder="Reference">
                        <input type="text" class="sea-input" id="IDNumber"  name="IDNumber" placeholder="ID Number">
                        </li><li><input type="text" class="sea-input" id="TrustName"  name="TrustName" placeholder="Trust Name">
                        <input type="text" class="sea-input" id="TrustNumber"  name="TrustNumber" placeholder="Trust Number">
                        
                        </li><li>
                        <button type="submit" class="reset" id="btnS" name="TrustCSISubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
