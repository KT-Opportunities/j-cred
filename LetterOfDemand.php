...
<html>
    ...
    <body>
        <?php 
        // session_destroy();
        if(isset($_POST['LODSubmit'])){
            $search = $_POST['guid'];
            $_SESSION['LetterGUID'] = $search;
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">Letter Of Demand</h3>

                        <ul>
                            <li>
                                <input type="text" id="ref"  name="ref" class="field-style field-split align-left" placeholder="Reference" />
                                <input type="text" id="comID"  name="guid" class="field-style field-split align-right" placeholder="Letter GUID" />
                            ...
                            <li>
                                <input type="submit" name="LODSubmit" value="Search" />
                            </li>
                        </ul>
...
$(document).ready(function(){
    // $(document).on('click', '#btnS', function() {
            ...
            $.ajax({
            type:"GET",
            url:"php/exportLetterOfDemand.php",
            // data: data4,
