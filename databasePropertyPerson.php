...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | Database Property Person</title>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['DataProPerSubmit'])){
                $ref = $_POST['ref'];
                ...
                $action = "Database Property Person : Ref=$ref;DeedsOffice=$DeedsOffice;Surname=$Surname;Firstname=$Firstname;IDNumber=$IDNumber";
                
                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Database Property Person','$action','$cu_id','$cu_email')";
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">Database Property Person</h3>
                        ...
                        <ul>
                            ...
                            <li>
                                <input type="submit" name="DataProPerSubmit" value="Search" />
                            </li>
                        </ul>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/DatabasePropertyPerson.php",
            // data: data4,
