...
<html>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['DeedsOfficeCompanySubmit'])){
                $ref = $_POST['ref'];
                ...
                $_SESSION['CompanyRegistrationNumber'] = $CompanyRegistrationNumber;
                
                $d8 = date('Y-m-d');
                $time = date('h:i:s');
                $cu_email = $_SESSION["email"];
                $action = "Deeds Office Records: rref=$ref;DeedsOffice=$DeedsOffice;CompanyName=$CompanyName;CompanyRegistrationNumber=$CompanyRegistrationNumber";

                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Deeds Office Records','$action','$cu_id','$cu_email')";
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        ...
                        <button type="submit" class="reset" id="btnS" name="DeedsOfficeCompanySubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
//  var data2 
        $.ajax({
        type:"GET",
        url:"php/DeedsOfficeCompanySearch.php",
        // data: data2,
        dataType: "json",
        success:function(result){
