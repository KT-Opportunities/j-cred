...
<html>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['ProCIPCSubmit'])){
                $ref = $_POST['ref'];
                $comID= $_POST['proID'];
                $SeaDes = $_POST['SeaDes'];
                $_SESSION['PropertyID'] = $comID;
...
//  var data2 
        $.ajax({
        type:"GET",
        url:"php/conversionsByPropertyID.php",
        // data: data2,
        dataType: "json",
        success:function(result){
