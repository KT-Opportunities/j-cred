...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | TransUnion Consumer Profile</title>
    ...
    <body>
        <?php 
        // session_destroy();
        if(isset($_POST['TransUnionConProSubmit'])){
            ...
            $d8 = date('Y-m-d');
                ...
                $action = "TransUnion Consumer Profile: IDNumber=$IDNumber";


$logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','TransUnion Consumer Profile','$action','$cu_id','$cu_email')";
...
<li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">TransUnion Consumer Profile </h3>
...
Fraud Detect">Fraud, Corruption, or Theft Investigation
Fraud Detect</option>
                   ...
                   <table id="union" class="table table-striped  table-hover" style="margin-top: 24px;">
                            <thead class="head">
                                <tr>
                                    ...
                                    <th scope="col">Enquiry Results ID</th>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/transUnionConsumerTraceByIDNumber.php",
            // data: data4,
