...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | CSI Company Records</title>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['companyCSISearch'])){
                $ref = $_POST['ref'];
                ...
                $action = "CSI Company Trace: ref=$ref;CompanyName=$CompanyName";

                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','CSI Company Trace','$action','$cu_id','$cu_email')";
...
<li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">CSI Company Trace</h3>
                        ...
                        <ul>
                            ...
                            <li>
                                <input type="submit" name="companyCSISearch" value="Search" />
                            </li>
                        </ul>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/CSICompanyTraceByName.php",
            // data: data4,
            ...
            console.log('Done1')
                ...
                for (let i = 0; i < result.ResponseObject.length; i++) {
                    ...
                    compu += '<tr>';
                    compu += '<td></td>';
                    compu += '<td>' +result.ResponseObject[i].CompanyInformation.CompanyID+ '</td>';
                    compu += '<td>' +result.ResponseObject[i].CompanyInformation.CompanyRegistrationNumber+ '</td>';
                    compu += '<td>' +result.ResponseObject[i].CompanyInformation.CompanyName+ '</td>';
                    compu += '<td>' +result.ResponseObject[i].CompanyInformation.RegistrationDate+ '</td>';
                    compu += '<td>' +result.ResponseObject[i].CompanyInformation.CompanyStatus+ '</td>';
                    compu += '<td>' +result.ResponseObject[i].CompanyInformation.CompanyStatusCode+ '</td>';
                    compu += '<td></td>';
                    compu += '</tr>';
                }
