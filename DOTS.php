...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | DOTS Property Search</title>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['DOTSSubmit'])){
                ...
                $action = "DOTS Records: Ref=$ref;DeedsOffice=$DeedsOffice;Barcode=$Barcode";

                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','DOTS Records','$action','$cu_id','$cu_email')";
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                    ...
                    <div id="jquery-accordion-menu" class="jquery-accordion-menu">
                        <ul>
                            ...
                            <li>
                                <a href="#"><i class=""></i>Intellingence Report</a>
                            </li>
                            <li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">DOTS Records</h3>
                        <ul><li>
                        ...
                        <li>
                        <input type="text" class="field-style field-split align-left" id="Barcode"  name="Barcode" placeholder="Barcode"><br>
                        
                        </li><li>
                        <button type="submit" class="reset" id="btnS" name="DOTSSubmit">Submit</button>
                </li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/DOTSPropertySearchByBarcode.php",
            // data: data4,
