...
<html>
    ...
    <?php
            if(isset($_POST['addOrg'])){
                ...
                $action = "New Organization Created : Name=".$name.";Tel=".$tel.";Email=".$email.";Address=".$address;
                
                $sql = "INSERT INTO organization (Name,tel,Address,Email) VALUES"."('$name','$tel','$address','$email')";
                $result = mysqli_query($conn,$sql);
                if($result){
                    $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Organization','$action','$cu_id','$cu_email')";
                    $result1 = mysqli_query($conn,$logs);
                    if($result1){
                    echo"<script>alert('Organization inserted successfully');</script>";
                    }else{
            ...
            if(isset($_POST['editOrg'])){
                ...
                $time = date('h:i:s');
                $cu_email = $_SESSION["email"];
                $action = "Organization Updated : Name=".$name.";Tel=".$tel.";Email=".$email.";Address=".$address;
                 $sql = "UPDATE organization SET email = '$email', Tel = '$tel', Address='$address',NAME='$name' WHERE ID = '$iD'";
                    ...
                    if($result1){
                        ...
                        echo "<script>console.log(".$conn->error.");alert('Organization update failed');</script>";  
                    }
            }
            if(isset($_POST['deleteOrg'])){
                ...
                $cu_email = $_SESSION["email"];
                $time = date('h:i:s');
                $action = "Organization Deleted : ID =". $iD;
                ...
                $result = mysqli_query($conn,$sql);
                    if($result){
                        ...
                        $result1 = mysqli_query($conn,$logs);
                    if($result1){
                        echo"<script>alert('Organization deleted successfully');</script>";
                    }else{
                         echo $conn->error;
                        echo "<script>console.log(".$conn->error.");alert('Organization deletion failed');</script>"; 
                    }
                    }else{
                        echo "<script>console.log(".$conn->error.");alert('Organization deletion failed');</script>";  
                    }
    ...
    ?>
            ...
            <div class="row header">
                    ...
                    <div class="col-md-6  col-sm-3 men">
                        <ul class="menu">
                            <li><a class="menubtn me">Menu</a></li>
                            <li><a class="menubtn"><img src="images/share.png" alt=""/></a></li>
                            <li><a class="menubtn"><img src="images/save.png" alt=""/></a></li>
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                    <div class="office">Juanita’s Office Online</div>
                    <div id="jquery-accordion-menu" class="jquery-accordion-menu">
                        <ul>
                            <li><a href="#"><i class="fas fa-user-alt"></i>INDIVIDUAL </a>
                                <ul class="submenu">
                                    <li><a href="individualCIPC.php">CIPC Records </a></li>
                            ...
                            <li><a href="#"><i class="far fa-building"></i>COMPANY</a>
                                <ul class="submenu">
                                    ...
                                    <li><a href="companyCIPC.php">CIPC Records </a></li>
                            ...
                            <!-- <li><a href="#"><i class="fas fa-home"></i>PROPERTY </a>
                                <ul class="submenu">
                                    
                                    <li><a href="propertyCIPC.php">Coordinate Search </a></li>
                                    <li><a href="#">Database Property </a></li>
                                    <li><a href="#">Deeds Office Records </a></li>
                                    <li><a href="DOTS.php">DOTS Records</a></li>
                                    <li><a href="#">Interactive Map </a></li>
                                    <li><a href="#">LightStone Reports </a></li>
                                    <li><a href="#">LightStone Valuations </a></li>
                                    <li><a href="#">Property Conversion </a></li>
                                    <li><a href="#">SAPTG Valustion </a></li>
                                    <li><a href="#">Transfer Report </a></li>
                                    <li><a href="#">Lookup Utility </a></li>
                                </ul>
                            </li> -->
                            ...
                            <li><a href="#"><i class="far fa-file-alt"></i>DOCUMENTS</a>
                                <ul class="submenu">
                                    ...
                                    <li><a href="#">CIPC Document </a></li>
                                    <li><a href="#">Court Document </a></li>
                                    <li><a href="#">CompuScan Document </a></li>
                                    <li><a href="#">Database Property</a></li>
                                    ...
                                    <!-- <li><a href="#">SG Diagram</a></li>
                                    <li><a href="#">TransUnion Document</a></li> -->
                ...
                <div class="col-md-10 col-sm-10 con">
                    <div class="seaTab">
                        ...
                        <div class="seaTable form-style-9">
                            <form action="" method="POST">
                                <h3 class="Trans">Add Organization</h3>
                                <ul>
                                    <li><input type="text" name="name" placeholder="Organization Name" class="field-style field-split align-left">
                                        <input type="email" name="email" placeholder="Email" class="field-style field-split align-right">
                                    <li>
                                        <input type="Tel"  name="tel" placeholder="Tel" class="field-style field-split align-left">
                                        <input type="text"  name="address" placeholder="Address" class="field-style field-split align-right">
                                    </li>
                            <li>    
                            <input type="submit" name="addOrg" value="Add Organization" />
                                    </li></ul>
                            </form>
                        </div>
                                    ...
                                    if($cu_type == 'Super-Super-Admin'){
                                        ...
                                        if ($res->num_rows > 0) {
                                           while($row = $res->fetch_assoc()) {
                                               echo "<tr onClick='edit(".$row['id'].")'><td>".$row['id']."</td><td>".$row['NAME']."</td><td>".$row['Email']."</td><td>".$row['tel']."</td><td>".$row['Address']."</td></tr>
                                               <div id='myModal".$row['id']."' class='modal' style='background-color: rgba(0,0,0,0.4);'>
                                                ...
                                                <ul><li>
                                                 <input hidden type='text' name='OrgID' value='".$row['id']."' class='fifinput1'>
                                                    <input type='text' name='NewName' placeholder='Organization Name' value='".$row['NAME']."' class='fifinput3'>
                                                    <input type='email' name='NewEmail' placeholder='Email' value='".$row['Email']."' class='fifinput3'>
                                                    </li><li>
                                                    <input type='tel' name='NewTel' placeholder='Tel' value='".$row['tel']."' class='fifinput3'>
                                                    <input type='text' name='NewAddress' placeholder='Address' value='".$row['Address']."' class='fifinput3'>
                                                    </li><li>
                                            <input type='submit' name='editOrg' value='Update Org' id='updateBtn' class='updateBtn' />
                                            <input type='submit' name='deleteOrg' value='Delete Org' id='deleteBtn' class='deleteBtn' />
                                            </li></ul>
                                                </form>
                                                </div></div>";
                                           }
                                           ...
                                           $sql = "SELECT * FROM organization WHERE ID='$cu_org'";
                                        $res = mysqli_query($conn,$sql);
                                        if ($res->num_rows > 0) {
                                           while($row = $res->fetch_assoc()) {
                                               echo "<tr onClick='edit(".$row['ID'].")'><td>".$row['ID']."</td><td>".$row['NAME']."</td><td>".$row['Email']."</td><td>".$row['tel']."</td><td>".$row['Address']."</td></tr>
                                        ...
                                        echo"<tr><td></td><td>Yoou are not authorized to see this</td><td></td></tr>";
                                    }
