...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | XDS Contact Information</title>
    ...
    <body>
        ...
        if(isset($_POST['XDSConSubmit'])){
            ...
            $d8 = date('Y-m-d');
                ...
                $action = "XDS Contact Information: IDNumber=$IDNumber;PassportNumber=$PassportNumber;Surname=$Surname ";

            
            $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','XDS Contact Information','$action','$cu_id','$cu_email')";
...
<li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">XDS Contact Information</h3>
                        ...
                        <ul>
                            <li>
                                ...
                                <input type="text" id="comID"  name="passportNum" class="field-style field-split align-left" placeholder="Passport Number" />
                                <input type="text" id="comID"  name="surname" class="field-style field-split align-right" placeholder="Surname" />
                            </li>
                            
                            <li>
                                <input type="submit" name="XDSConSubmit" value="Search" />
                            </li>
                        </ul>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/XDSContactInformation.php",
            // data: data4,
            ...
            console.log('Done1')
                ...
                // console.log(('V: ' ,result.ResponseObject[0].PersonInformation.FirstName));
                
                // var union = '';
                // for (var i = 0; i < result.ResponseObject[i].length; i++) {
            
        
                //     union += '<tr>';
                //     union += '<td></td>';
                //     union += '<td>' +result.ResponseObject[i].PersonInformation.FirstName+ '</td>';
                //     union += '<td>' +result.ResponseObject[i].PersonInformation.Surname+ '</td>';
                //     union += '<td>' +result.ResponseObject[i].PersonInformation.IDNumber+ '</td>';
                //     union += '<td>' +result.ResponseObject[i].PersonInformation.Gender+ '</td>';
                //     union += '<td>' +result.ResponseObject[i].PersonInformation.EnquiryID+ '</td>';
                //     union += '<td>' +result.ResponseObject[i].PersonInformation.EnquiryResultID+ '</td>';
                //     union += '<td>' +result.ResponseObject[i].PersonInformation.Description+ '</td>';
                //     union += '</tr>';
