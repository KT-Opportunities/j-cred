...
<html>
    ...
    <body>
        <?php 
            ...
            if(isset($_POST['LightStoneBusinessSubmit'])){
                $ref = $_POST['ref'];
                ...
                $_SESSION['SearchDescription'] = $SearchDescription;
                $_SESSION['PropertyID'] = $PropertyID;
        
                $d8 = date('Y-m-d');
                $time = date('h:i:s');
                $cu_email = $_SESSION["email"];
                $action = "LightStone Property: ref=$ref;PropertyID=$PropertyID;SearchDescription=$SearchDescription";
                
                
                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','LightStone Property','$action','$cu_id','$cu_email')";
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">LightStone Property</h3>
                        <ul><li>
                        <input type="text" class="field-style field-split align-left" id="ref"  name="ref" placeholder="Reference">
                        <input type="text" class="field-style field-split align-right" id="PropertyID"  name="PropertyID" placeholder="Property ID"></li><li>
                        <input type="text" class="field-style field-split align-left" id="SearchDescription"  name="SearchDescription" placeholder="Search Description">
                        </li><li>
                        
                        <button type="submit" class="reset" id="btnS" name="LightStoneBusinessSubmit">Submit</button>
</li></ul>
                    </form>
                    <h3>Results</h3>
                    <div id="dem">
...
//  var data2 
        $.ajax({
        type:"GET",
        url:"php/lightStonePropertyValuationSearchOnPropertyID.php",
        // data: data2,
        dataType: "json",
        success:function(result){
