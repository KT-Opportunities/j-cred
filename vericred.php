...
<html>
    ...
    <body>
        <?php 
        // session_destroy();
        if(isset($_POST['VeriCredSubmit'])){
            $search = $_POST['IDnum'];
            $_SESSION['IDnum'] = $search;
            $d8 = date('Y-m-d');
                $time = date('h:i:s');
                $cu_email = $_SESSION["email"];
                $action = "VeriCred Contact Information: search=$search ";
                $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','VeriCred Contact Information','$action','$cu_id','$cu_email')";
...
<li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        <h3 class="Trans">VeriCred Contact Information</h3>
...
$(document).ready(function(){
            ...
            console.log('Done1')
                ...
                var compu = '';
                    ...
                    compu += '<td> <a href="vericredView.php?x=' +result.ResponseObject.PersonInformation.IDNumber+'&y='  +result.ResponseObject.PersonInformation.Fullname+ '">View<a/></td>';
                    compu += '</tr>';
