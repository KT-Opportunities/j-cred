            ...
            <div class="col-md-2 col-sm-2 sidenav">
                    ...
                    <div id="jquery-accordion-menu" class="jquery-accordion-menu">
                        <ul>
                            ...
                            <li>
                                <a href="#"><i class=""></i>BBEEE (coming soon)</a>
                            </li>
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <form action="" method="POST">
                        ...
                        <h3 class="Trans">Individual CIPC Records</h3>
                        

                        <ul>
                            <li>
                                <input type="text" name="Reference" class="field-style field-split align-left" placeholder="Reference" />
                                <input type="text" name="Surname" class="field-style field-split align-right" placeholder="Surname" />

                            </li>
                            <li>
                                <input type="text" name="Firstname" class="field-style field-split align-left" placeholder="Firstname" />
                                <input type="url" name="IDNumber" class="field-style field-split align-right" placeholder="IDNumber" />
                            </li>
                            <!-- <li>
                                 <input type="text" name="field3" class="field-style field-full align-none" placeholder="Subject" />
                            </li> -->
                            <li>
                                <input type="submit" name="IndiCIPCSubmi" value="Search" />
                            </li>
                        </ul>


                        <!-- <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6 frm">
                                <input type="text" class="sea-input" id="ref" placeholder="Reference" name="ref"><br>
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 frm">
                                 <input type="text" class="sea-input" id="Surname" placeholder="Surname" name="Surname">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6 frm">
                                 <input type="text" class="sea-input" id="Firstname" placeholder="Firstname" name="Firstname">
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 frm">
                                <input type="text" class="sea-input" id="IDNumber" placeholder="IDNumber" name="IDNumber">
                            </div>
                        </div>

                        <div class="row frm">
                            <button type="submit" class="reset" id="btnS" name="IndiCIPCSubmi">Submit</button>
                        </div> -->
