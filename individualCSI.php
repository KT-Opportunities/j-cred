...
<html>
    <head>
        <meta charset="UTF-8">
        <title> J.CRED | CSI Person Records</title>
    ...
    <body>
        ...
        if(isset($_POST['IndiCSISubmi'])){
            ...
            $action ="New Individual CSI Search: Surname=$surname;Firstname=$firstName;ID#=$idNumber";
            
            $logs = "INSERT INTO logs (Date,Time,Page,Action,user_ID,User) VALUES"."('$d8','$time','Individual CSI','$action','$cu_id','$cu_email')";
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-2 col-sm-2 sidenav">
                ...
                <div class="col-md-10 col-sm-10 con">
                    ...
                    <div class="form-style-9" style="margin-top: 20px">
                    <form action="" method="POST">
                        <h3 class="Trans">CSI Person Records</h3>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <input type="text" name="IDNumber" class="field-style field-split align-right" placeholder="IDNumber" />
                            </li>
                            
                            <li>
                                <input type="submit" name="IndiCSISubmi" value="Search" />
                            </li>
                        </ul>
                    ...
                    <h3>Results</h3>
                     ...
                     <div class="seaTable">
                        <table id="csi" class="table table-striped  table-hover">
                            <thead class="head">
                                <tr>
                                    ...
                                    <th scope="col">Second Middle Name</th>
...
$(document).ready(function(){
            ...
            $.ajax({
            type:"GET",
            url:"php/CSIPersonTraceByIDNumber.php",
            // data: data4,
            ...
            console.log('Done1')
                ...
                var compu = '';
                    ...
                    compu += '<td>' +result.ResponseObject.PersonInformation.MiddleName2+ '</td>';
                    compu += '<td> <a href="individualCSIView.php?x=' +result.ResponseObject.PersonInformation.IDNumber+'&y='  +result.ResponseObject.PersonInformation.Fullname+ '">View<a/></td>';
                    compu += '</tr>';
